  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>We don’t use trackers of any kind.</li>
        <li>There are no ads and no other 3rd party services.</li>
        <li>
          In order to log you into this web app, we use the Twitter API. At at
          minimum, Twitter gives developers the ability to read tweets and other
          basic profile information. We will never use this ability and if we
          could give up that ability, we would.
        </li>
        <li>
          The only info we do collect is the result of server logs which contain
          anonymized IP addresses and service access times.
        </li>
      </ul>
      <p>
        In short, we try <em>not</em> to collect any information on you at all.
      </p>
      <p>
        <strong>
          Simplicity and transparency is the appeal and identity of this service
          and that will never change.
        </strong>
      </p>
      <p>
        Feel free to browse this website's{' '}
        <a href="https://github.com/ricokahler/longtweet.io">source code</a>.
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to longtweet.
          </p>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to longtweet, accessible from{' '}
            <a
              href="https://longtweet.io"
      ...
      <p>
        ...
        such as Your name, Your activities or Your contact list associated with
        that account.
      </p>
      <p>
      ...
      <p>We don’t use cookies. Period.</p>
      ...
      <p>
        We do not sell personal information. We do not partner with any Service
        Providers that may sell personal information as defined by the CCPA law.
      </p>
      <h1>
      ...
      <p>
        ...
        <br />
        (this is N/A — we just don’t track you to begin with).
      </p>
      <p>
      ...
      <ul>
        <li>By email: hello@longtweet.io</li>
      </ul>
    </>
  );
}
